...
function enRoute(kind, key) {
    ...
    return (
      {
        ...
        "free-standing": "/products/roll-mouth-cake-cups/",
  ...
  if (kind === "app")
    return ({ bakeries: "/applications/bakery/", foodservice: "/applications/food-service/" }[key] || "/applications/");
  return (
    {
      products: "/products/",
      apps: "/applications/",
